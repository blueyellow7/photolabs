...
const PhotoListItem = ({ photoId, regularPhoto, profilePhoto, name, location, likesArray, handleLikesArray, showModal, handleShowModal, selectedPhoto, handleSelectedPhoto }) => {
  return (
